...
describe('Slice 3: Buying Producers & Tick', function() {
  ...
  describe('The buyButtonClick function', function() {
    ...
    it('mutates the data only if the player can afford the producer', function() {
      // `buyButtonClick` accepts a browser event argument. Here, we simulate this by creating an event object ourselves. 
      // We'll only give that fake event object the properties that are relevant for our purposes.
